...
if [ $1 == "mesu" ]; then
    ...
    echo "Impossible to measure cache in unknown machines. Please install ocperf (see README) and edit this script to get cache measurements."
...
cat run-cache.sh > $dirr/backup-run.sh
